...
The first Pytroll workshop held in Norrköping, Sweden, end of November, 2012,
has come to an end. 9 people from Holland, Finland, Romania and EUMETSAT
joined up with the pytroll teams at DMI and SMHI, to get more acquainted
with the pytroll tools and how it can be used in their local environments
for satellite data production.
...
.. |figuretext| replace:: It seems the workshop was quite successful. Maybe there will be another workshop in 2013 or later at DMI or SMHI. If so, we will of course announce this on the mailing list (pytroll@googlegroups.com).
