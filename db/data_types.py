...
dbm.create_file_format(7, 'EPS', 'EPS Native Format')
dbm.create_file_format(8, 'GeoTIFF', 'GeoTIFF data')
dbm.create_file_format(9, 'PNG', 'PiNG format')
...
dbm.create_file_type(5, 'image', 'image')
