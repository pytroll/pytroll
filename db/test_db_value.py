...
nf = dcm.create_file('test6', file_type=ft, file_format=ff)


nf1 = dcm.create_file('test7', file_type_name='HRPT', file_format_name='hrpt level 0')
print nf
p = dcm.get_parameter('orbit_number')

pv = dcm.create_parameter_value(666, file_obj=nf, parameter=p)
pv = dcm.create_parameter_value(666, filename='test7', parameter_name='orbit_number')
...
pls = dcm.create_parameter_linestring(wkt_o, filename="test7", parameter_name="sub_satellite_track")
